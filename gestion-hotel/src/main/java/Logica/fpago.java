...
public class fpago {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String[] titulos={"ID","Id Reserva","Tipo de comprobante","Num de comprobante","Impuestos","Total de pago","Fecha de emision","Fecha de pago"};
        ...
        try {
            ...
            while (rs.next()){
                ...
                registro[4]=rs.getString("impuestos");
    ...
    public boolean insertar (vpago dts){
        sSQL="insert into pago(idreserva, tipo_comprobante, num_comprobante,impuestos,total_pago,"
        ...
        try {
            ...
            pst.setDouble(4,dts.getImpuestos());
    ...
    public boolean editar (vpago dts){
        sSQL="update pago set idreserva=?,tipo_comprobante=?,num_comprobante=?, "
                + "impuestos=?, total_pago=?, fecha_emision=?, fecha_pago=?"+
                " where idpago=?";
        try {
            PreparedStatement pst= cn.prepareStatement(sSQL);
            pst.setInt(1,dts.getIdreserva());
