...
public class fconsumo {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String[] titulos={"ID","Id Reserva","Id Producto","Producto","Cantidad",
        "Precio venta","Estado"};
        ...
        sSQL="select c.idconsumo,c.idreserva, c.idproducto, p.nombre, c.cantidad, "
                + "c.precio_venta, c.estado from consumo c inner join producto p "
                + "on c.idproducto=p.idproducto where c.idreserva='"+buscar
                +"' order by c.idconsumo";
